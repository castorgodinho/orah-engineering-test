        ...
        <div>
          <RollStateList
            stateList={[
              ...
              { type: "present", count: stateList.filter(ele => ele.roll_state === "present").length  },
              { type: "late", count: stateList.filter(ele => ele.roll_state === "late").length },
              { type: "absent", count: stateList.filter(ele => ele.roll_state === "absent").length },
            ]}
